...
export default function CaseSummaryCard({ patient: _patient }: CaseSummaryCardProps) {
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden">
      ...
      <div className="p-5">
        <p className="text-sm text-zinc-400 leading-relaxed mb-4">
          Patient presents with chronic hypertension and associated visual disturbances. Monitor for
          potential cardiovascular complications. Latest lab results show elevated serum creatinine
          levels.
        </p>
