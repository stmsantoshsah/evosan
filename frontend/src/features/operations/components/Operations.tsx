  ...
  return (
    <div className="flex flex-col h-[calc(100vh-2rem)] gap-6 p-4 md:p-6 overflow-hidden">
      ...
      <div className="flex justify-end">
        <a
          href="/focus"
          className="bg-teal-600 hover:bg-teal-500 text-black font-bold py-3 px-6 rounded-lg flex items-center gap-2 transition-all hover:scale-105 shadow-lg shadow-teal-900/50"
        >
          ⚡ ENTER FOCUS MODE
        </a>
      </div>
