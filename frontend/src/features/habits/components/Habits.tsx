  ...
  return (
    <div className="max-w-4xl mx-auto pb-20">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-10 gap-6">
        ...
        <div className="flex items-center gap-4 bg-zinc-900 border border-zinc-800 rounded-2xl p-4 pr-6">
          <div className="relative w-16 h-16 flex items-center justify-center">
            ...
            <span
              className={`absolute text-sm font-bold ${integrity === 100 ? 'text-yellow-500' : 'text-white'}`}
            >
              {integrity}%
            </span>
          </div>
          <div>
            ...
            <p
              className={`text-lg font-bold ${integrity === 100 ? 'text-yellow-500' : 'text-white'}`}
            >
      ...
      <form
        ...
        className="flex flex-col md:flex-row gap-4 mb-12 bg-zinc-900/30 p-4 rounded-xl border border-zinc-800/50"
      >
        <input
          type="text"
