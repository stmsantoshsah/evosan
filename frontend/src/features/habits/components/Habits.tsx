...
export default function Habits() {
    ...
    return (
        <div className="max-w-3xl mx-auto">
            ...
            {/* --- ADD NEW HABIT --- */}
            <form onSubmit={handleCreateHabit} className="flex flex-col md:flex-row gap-4 mb-10 bg-zinc-900/50 p-4 rounded-lg border border-zinc-800">
                <input
                    type="text"
                ...
                <button
                    type="submit"
                    disabled={isLoading}
                    className="bg-cyan-600 hover:bg-cyan-500 text-white px-6 py-2 rounded font-bold transition-colors disabled:opacity-50"
                >
            ...
            <div className="grid gap-4">
                ...
                {isFetchingHabits && <div className="text-center py-10 text-zinc-500">Updating protocol...</div>}
