          ...
          <div className="px-6 pb-6 -mt-12 flex flex-col items-center text-center">
            ...
            <div className="w-full mb-6">
              ...
              <p className="text-[10px] text-zinc-600 mt-2 text-center">
                {gamification.nextLevelXP - gamification.xp} XP to{' '}
                {gamification.title === '10x Engineer' ? 'Self Actualization' : 'Next Rank'}
              </p>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-zinc-900 border border-zinc-800 p-4 rounded-xl">
            ...
            <p className="text-2xl font-bold text-white">
              {(stats.volumeMoved / 1000).toFixed(1)}k
            </p>
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            {isEditable &&
              (!isEditingManifesto ? (
                ...
                <button
                  onClick={handleSave}
                  className="text-emerald-500 hover:text-emerald-400 transition-colors flex items-center gap-1 text-xs font-bold uppercase"
                >
          ...
          {isEditingManifesto ? (
            ...
            <div className="relative">
              ...
              <p className="pl-6 text-zinc-300 font-mono text-sm md:text-base leading-relaxed italic opacity-80">
                "
                {manifestoContent ||
                  'I am building this system to become the most disciplined version of myself, ensuring my physical hardware (body) can support my software (mind).'}
                "
              </p>
            </div>
          )}
