        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-1/3 bg-zinc-900 border border-zinc-800 rounded-xl p-6 flex items-center justify-between">
              <div>
                <h2 className="text-zinc-500 text-xs font-mono mb-1 uppercase tracking-widest">
                  Weekly Optimization
                </h2>
                <div
                  className={`text-4xl font-bold ${analysis.score > 70 ? 'text-teal-400' : 'text-orange-400'}`}
                >
                  {analysis.score}%
                </div>
              </div>
            ...
            <div className="w-full md:w-2/3 bg-zinc-900 border border-zinc-800 rounded-xl p-6 flex flex-col justify-center">
              ...
              <p className="text-zinc-300 text-sm">
                ...
                <span className="text-white font-bold">Keep pushing.</span>
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-black border border-purple-900/30 rounded-xl p-6 relative overflow-hidden">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">{analysis.pattern}</p>
            </div>
            ...
            <div className="bg-black border border-red-900/30 rounded-xl p-6 relative overflow-hidden">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">{analysis.friction}</p>
            </div>
          </div>
          ...
          <div className="bg-teal-900/10 border border-teal-500/30 rounded-xl p-8 flex flex-col md:flex-row items-start gap-6">
            ...
            <div className="flex-1">
              <h3 className="text-teal-400 font-bold font-mono text-lg mb-2">
                🚀 TACTICAL DIRECTIVE
              </h3>
              <p className="text-teal-100 text-lg font-medium mb-4">"{analysis.directive}"</p>
